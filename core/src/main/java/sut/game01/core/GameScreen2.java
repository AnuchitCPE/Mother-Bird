...
public class GameScreen2 extends Screen {
    ...
    public GameScreen2(final ScreenStack ss) {
        ...
        Image bgImage = assets().getImage("images/gameBg2.png");
        ...
        foodMap.add(new Food(world, 950f, 240f));
        foodMap.add(new Food(world, 1500f, 100f));
        foodMap.add(new Food(world, 550f, 250f));

        rockMap.add(new Rock(world, 200f, 100f));
        rockMap.add(new Rock(world, 200f, 400f));
        rockMap.add(new Rock(world, 400f, 250f));
        rockMap.add(new Rock(world, 400f, 420f));
        rockMap.add(new Rock(world, 400f, 80f));
        rockMap.add(new Rock(world, 600f, 350f));
        rockMap.add(new Rock(world, 600f, 100f));
        rockMap.add(new Rock(world, 700f, 250f));
        rockMap.add(new Rock(world, 800f, 250f));
        rockMap.add(new Rock(world, 900f, 400f));
        rockMap.add(new Rock(world, 900f, 100f));
        rockMap.add(new Rock(world, 1100f, 100f));
        rockMap.add(new Rock(world, 1100f, 300f));
        rockMap.add(new Rock(world, 1200f, 150f));
        rockMap.add(new Rock(world, 1200f, 250f));
        rockMap.add(new Rock(world, 1300f, 200f));
        rockMap.add(new Rock(world, 1300f, 400f));
        rockMap.add(new Rock(world, 1450f, 300f));
        rockMap.add(new Rock(world, 1600f, 200f));
        rockMap.add(new Rock(world, 1600f, 300f));
        rockMap.add(new Rock(world, 1600f, 400f));
        rockMap.add(new Rock(world, 1900f, 100f));
        rockMap.add(new Rock(world, 1900f, 200f));
        rockMap.add(new Rock(world, 1900f, 300f));
        rockMap.add(new Rock(world, 2100f, 200f));
        rockMap.add(new Rock(world, 2100f, 300f));
        rockMap.add(new Rock(world, 2100f, 400f));
